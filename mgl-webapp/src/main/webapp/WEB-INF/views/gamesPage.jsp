...
<%@ taglib tagdir="/WEB-INF/tags" prefix="mgl" %>
    ...
    <body ng-app="game_app" class="ng-cloak">
        <mgl:myNav/>
        <br>
        <div class="container" ng-controller="GameController as ctrl">
            <div class="panel panel-default">
                ...
                <div class="formcontainer">
                    <form ng-submit="ctrl.addOrUpdateGame()" name="gameForm" class="form-horizontal">
                    ...
                    <table class="table table-dark table-striped text-light">
                        ...
                        <tbody>
                            <tr ng-repeat="currentGame in ctrl.games">
                                ...
                                <td><button ng-click="ctrl.deleteGame(currentGame)" class="btn btn-secondary btn-sm"> Delete</button></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
